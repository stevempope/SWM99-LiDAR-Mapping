...
public class LReturn {
	 ...
	 */
	public LReturn (Double start, Double blockage) {
		startAngle = start;
		returnList = new ArrayList<Double>();
	}
	 ...
	 */
	public LReturn (Double start, ArrayList<Double> blocks, Double end) {
		startAngle = start;
		returnList = blocks;
		endAngle = end;
	}
	 ...
	 */
	public Double getDistance(Double theAngle) {
		return returnList.get(theAngle.intValue());
	}
	...
	public void appendBlocks(ArrayList<Double> blocks){
